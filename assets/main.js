$(document).ready(function(){
	...
	function getMainTimeline(){
		...
		.to($windowLeftOutline, 1, {strokeDashoffset: 0, ease:Power1.easeOut})
		.to($windowRightOutline, .25, {strokeDashoffset: 0, ease:Power1.easeOut}, "-=0.4")
